...
def check_live(cookie):
	...
	try:
		...
		return f'\033[1;37m~\033[1;37m[\033[1;31m</>\033[1;37m] \033[1;37m=> {luc}Tên Facebook:  {vang}{name}{trang} | {luc}ID: {vang}{user_id}{trang}'
	except:
		return False
clear()
banner()
show_info()
cookie = input(f'\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;32mNhập Cookie Facebook:\033[1;33m ')
...
while True:
	dl = int(input(f'\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;32mNhập Delay:\033[1;33m '))
	thanh()
	...
	for add in find:
		...
		print(f'\033[1;37m~[\033[1;31m</>\033[1;37m]\033[1;37m ~> {trang}[{vang}{dem}{trang}] ~> {xnhac}Add Friend {trang}~> {luc}Tên: {vang}{name_} {trang}~> {luc}ID: {vang}{id}{trang}')
		idelay(dl)